...
('Rum Gran Reserva 1888', 'Brugal', 'Ambrato scuro alla vista, è intenso al naso con sensazioni di frutta secca accompagnate da delicate note legnose. Al palato è avvolgente e lungo, con toni burrosi e zuccherati. Chiude caramellato e sapido.', 45.00, 'brugal.jpg', 20, 1, "40", "70 cl"),
...
('La Blanche du Mont Blanc', 'Brasserie', "Cremosa e corposa, questa birra di frumento dolce ha aromi fruttati e un retrogusto di coriandolo. ", 2.99,'balche_mont_blank.png',30,6, "4,7", "33 cl"),
('Valdobbiadene Superiore', 'Bortolomiol', "Nel calice si presenta con un colore giallo paglierino, con qualche leggero riflesso tendente all’oro e al verdolino. Il perlage è sottile e persistente. ", 12.20,'valdobbiadene.jpeg',10,10, "12", "75 cl"), 
('Millesimato DOC', "Sant'Orsola", "Alla vista regala un bel giallo paglierino, con bollicina durevole e sottile. I sentori al naso sono leggiadri e freschi, fruttati perlopiù, con note di mela e di pera a guidare l’olfattiva. ", 7.50,'sant_orsola.jpeg',20,10, "11.5", "75 cl"), 
('Ferrari Maximum', "Ferrari", "Giallo paglierino intenso, dal perlage fine e persistente. Al naso è gentile, intenso e persistente, con una nota di frutta matura nella quale si riconoscono sentori di crosta di pane, nocciola e un variegato bouquet floreale. ", 19.90,'ferrari.jpeg',15,11, "12,5", "75 cl"),
('Toscana Rosso IGT', "Casale Sparviero", "Rosso rubino intenso dai riflessi porpora. Intenso al naso con note di frutti rossi e neri succosi, viole e rose. In bocca è elegante, con i tannini delicati e integrati nel corpo.", 7.50,'sparvierorosso.jpeg',20,12, "13,5", "75 cl"),
('Valpolicella DOC 2019', "Tommasi", "Rosso rubino di buona intensità alla vista. Fresco e fruttato all’olfattiva, caratterizzato da sentori di ciliegia e fragola. L’assaggio si dimostra in linea con il naso, fragrante ma equilibrato, connotato da una buona persistenza.", 10.50,'tommasi.jpeg',20,13, "15", "75 cl"),
('Chianti Riserva DOCG', "Piccini", "Rosso rubino il colore al calice. Intenso il bouquet olfattivo, composto da sentori fruttati che richiamano la prugna e la marasca, e poi impostato su rimandi terziari di vaniglia e spezie.", 7.50,'piccini.jpeg',20,14, "14", "75 cl"),
...
('Diplomatico N.2', 'Distillery Collection', 'Si sviluppa nel bicchiere con un colore giallo dorato intenso e concentrato. Lo spettro olfattivo si muove su una progressione di note fruttate dolci, arricchite anche da sentori terziari e tocchi più tostati. ' ,89.50, 'diplomatico.jpeg', 3, 1, "42", "70 cl"),
('Plantation Rum', 'Maison Ferrand', 'Color ambra, con riflessi mogano. Il profilo olfattivo è caratterizzato da grande ricchezza e complessità, con aromi di frutta esotica, canna da zucchero, vaniglia, agrumi canditi, cacao, nuances boisé e fumé.', 65.50, 'plantation.jpeg', 10, 1, "37,5", "70 cl"),
('Highland 18', 'Aberlour', 'All’esame visivo ha una tonalità che varia dal dorato al castano ramato. Lo spettro olfattivo manifesta note complesse e stratificate, con aromi di toffee, pesca matura e arancia amara.', 59.00,'aberlour.jpeg',15,4, "40", "70 cl"),
('Islay Scotch 1997', 'Bowmore', 'Al naso si susseguono note dolci di zucchero di canna e gelato malaga, in contrappunto con sensazioni iodate e ricordi di alga. Al sorso tornano i sentori dolci di uvetta, marmellata, cacao, con un netto sentore torbato di fondo. ', 230.50,'islay.jpeg',2,4, "40", "70 cl"),
('Hinch Blended 5', 'Hinch', 'Giallo dorato dai riflessi ambrati alla vista. Il naso è dolce e agrumato, con cenni di vaniglia e spezie. Al palato è morbido, con note di vaniglia, albicocca e pesca in evidenza.', 58.50,'hinch.jpeg',20,4, "38", "70 cl"),
('Prosecco Bio Treviso', 'Corvezzo', "Giallo paglierino brillante, con effervescenza persistente. Arrivano al naso profumi freschi, fruttati e aromatici, che ricordano la pera e la salvia soprattutto. ", 8.00,'corvezzo.jpeg',18,10, "11,5", "75 cl"), 
('Storie di Noir', 'Bosco Levada', "Giallo paglierino intenso, con riflessi dorati; perlage fine e persistente. Al naso si esprime con sentori di mela e pera matura, note di melagrana e cenni agrumati. Al palato è fresco, croccante e armonico. ", 10.80,'noir.jpeg',13,10, "13", "75 cl"),
...
('Chianti Classico DOCG 2018', "Riecine", "Rosso rubino scarico. Sentori di viola e frutti rossi al naso. Leggermente speziato. Rotondo, ampio e voluminoso in bocca. È un vino ben delineato, finemente evoluto, con tannini leggeri, tipico, docile ed elegante.", 23.00,'riecine.jpeg',20,14, "14", "75 cl"),
('Emilia Lambrusco Rosso Frizzante', "Bassoli", "Rosso rubino intenso alla vista. Frutta rossa, scura e croccante al naso, viene seguita da sfumature leggermente erbacee, che rendono il bouquet olfattivo lineare e piacevole. Fresco l’assaggio ma comunque equilibrato. Buona lunghezza.", 9.90,'bassoli.jpeg',30,15, "13", "75 cl");
